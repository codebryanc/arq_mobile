...
const _kAssetPath =
    'lib/features/category/data/mock/genre_movie_list_test.json';
  ...
  group('CategoryLocalDataSource', () {
    group('getCategories', () {
      test('returns list of CategoryModel when asset exists', () async {
        // Arrange
        _setUpMockAssets({_kAssetPath: jsonEncode(_buildGenreResponse())});
      ...
      test(
        'returns multiple categories when asset has multiple genres',
        () async {
          // Arrange
